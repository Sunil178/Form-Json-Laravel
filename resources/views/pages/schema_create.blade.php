...
@section('content')
	...
	<form action="{{ route('pages.store') }}" method="POST" id="page_form">
		@csrf
		<input type="hidden" name="schema" id="json-schema" autocomplete="off">
		
		<label>Page No.:</label>
		<div class="row">
			<input type="text" placeholder="Page No." name="number" required />
		</div>
		<div class="error-message"></div>

		<label>Page Name:</label>
		<div class="row">
			<input type="text" placeholder="Page Name" name="name" required />
		</div>
		<div class="error-message"></div>
