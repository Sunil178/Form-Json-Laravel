...
function make_node(node_in) {
    var value = JSON.stringify(node_in);
    console.log(" ====> " + value);
    ...
    if (type === "[object Object]") {
        ...
        if (value == '"number"') {
            return $('<pre data-role="value" data-type="string" data-value="number">').html(node_in);
        } else if (value == '"textarea"') {
            return $('<pre data-role="value" data-type="string" data-value="textarea">').html(node_in);
        } else {
...
$(document).on('input', '[data-value="number"] form input', function (event) {
    let number_value = $(this).val();
    $(this).val(number_value.replace(/[^0-9]/g, ''));
});

$(document).on('focus', '[data-value="number"] form input', function (event) {
    let number_value = $(this).val();
